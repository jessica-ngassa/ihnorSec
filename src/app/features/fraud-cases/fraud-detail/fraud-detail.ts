...
//   standalone: true,
//   imports: [CommonModule, LucideAngularModule, AnomaliesDetected, OcrDocumentViewer, ProfileSummary],
...
//       { field: 'Recipient', expected: data.paymentData.recipientName, actual: data.paymentData.recipientName, match: true },
//       { field: 'Amount', expected: data.paymentData.expectedAmount, actual: data.paymentData.actualAmount, match: data.paymentData.expectedAmount === data.paymentData.actualAmount }
//     ];
//   });
...
// src/app/features/fraud-cases/fraud-detail/fraud-detail.ts
